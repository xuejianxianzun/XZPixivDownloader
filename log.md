...
```
69493962_p0.png: 69493962_p0_bmk_2206_tags_FGO,ジャンヌ・オルタ,Fate_GO1000users入り,魅惑の谷間.png
```

每个名字前面加了这个图片默认的名字，如 69493962_p0.png。默认名字和实际名字中间用 ```: ``` 分割。
...
```
ren 69493962_p0.png "69493962_p0_bmk_2210_tags_FGO,ジャンヌ・オルタ,Fate_GO1000users入り,魅惑の谷間.png"
```
